...
class DemandeRepository extends ServiceEntityRepository
{
    ...
    /**
     * Find all demandes for a specific opportunity
     *
    ...
    /**
     * Find pending demandes for a user
     *
     * @param int $userId
     * @return Demande[]
     */
    ...
    /**
     * Find all demandes to opportunities belonging to a company
     *
     * @param int $companyId
     * @return Demande[]
     */
